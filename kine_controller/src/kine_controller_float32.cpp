...
int main(int argc, char **argv){    
    ...
    int queue_size = 1; 
    pubL = node.advertise<std_msgs::Float32>("/vrep/vehicle/motorLeftSpeed",queue_size);
    pubR = node.advertise<std_msgs::Float32>("/vrep/vehicle/motorRightSpeed",queue_size);
